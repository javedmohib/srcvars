...
# compare_identical_sheets (old_version_path, new_version_path, output_file = "misc/example.xlsx", OVER_WRITE = TRUE)
compare_identical_sheets <- function(old_version_path, new_version_path, output_file, OVER_WRITE = TRUE) {
